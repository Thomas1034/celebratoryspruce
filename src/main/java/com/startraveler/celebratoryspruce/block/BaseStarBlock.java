...
public abstract class BaseStarBlock extends BaseEntityBlock {
    private static final VoxelShape SHAPE = Block.column(8.0F, 0.0F, 10.0F);

    public BaseStarBlock(Properties properties) {
        super(properties);
    }
